...
return [
    ...
    // new user:
    'welcome'                                   => 'Welcome to Expenses manager!',
    'submit'                                    => 'Submit',
    'submission'                                => 'Submission',
    'submit_yes_really'                         => 'Submit (I know what I\'m doing)',
    'getting_started'                           => 'Getting started',
    'to_get_started'                            => 'It is good to see you have successfully installed Expenses manager. To get started with this tool please enter your bank\'s name and the balance of your main checking account. Do not worry yet if you have multiple accounts. You can add those later. It\'s just that Firefly III needs something to start with.',
    'savings_balance_text'                      => 'Expenses manager III will automatically create a savings account for you. By default, there will be no money in your savings account, but if you tell Firefly III the balance it will be stored as such.',
    ...
    'set_preferred_language'                    => 'If you prefer to use Expenses manager  in another language, please indicate so here.',
    'language'                                  => 'Language',
    ...
    'firefly_instance_configuration'   => 'Configuration options for Expenses manager',
    'setting_single_user_mode'         => 'Single user mode',
    'setting_single_user_mode_explain' => 'By default, Expenses manager only accepts one (1) registration: you. This is a security measure, preventing others from using your instance unless you allow them to. Future registrations are blocked. When you uncheck this box, others can use your instance as well, assuming they can reach it (when it is connected to the internet).',
    ...
    'import_index_title'                    => 'Import transactions into Expenses manager',
    'import_data'                           => 'Import data',
    'import_transactions'                   => 'Import transactions',

    // sandstorm.io errors and messages:
    'sandstorm_not_available'               => 'This function is not available when you are using Expenses manager within a Sandstorm.io environment.',
    ...
    'no_accounts_imperative_asset'          => 'To start using Expenses manager you must create at least one asset account. Let\'s do so now:',
    ...
    'no_recurring_intro_default'            => 'You have no recurring transactions yet. You can use these to make Expenses manager automatically create transactions for you.',
    ...
    'help_first_date_no_past'            => 'Indicate the first expected recurrence. Expenses manager will not create transactions in the past.',
    ...
    'help_weekend'                       => 'What should Expenses manager do when the recurring transaction falls on a Saturday or Sunday?',
